...
data:extend{
    {
        ...
        graphics_set = {
          animation = {
              layers = {
                  {
                      filename = "__Age-of-Production__/graphics/entity/armory/armory-hr-shadow.png",
                      priority = "high",
                      width = 600,
                      height = 500,
                      frame_count = 1,
                  ...
                  },
                  {
                      ...
                      stripes = {
                          {
                              filename = "__Age-of-Production__/graphics/entity/armory/armory-hr-animation-1.png",
                              width_in_frames = 8,
                              height_in_frames = 8
                          },
                          {
                              filename = "__Age-of-Production__/graphics/entity/armory/armory-hr-animation-2.png",
                              width_in_frames = 8,
                              height_in_frames = 2
                          }
                      }
                  ...
                  animation = {
                      layers = {
                          ...
                          },
                          {
                              ...
                              stripes = {
                                  {
                                      filename = "__Age-of-Production__/graphics/entity/armory/armory-hr-emission-1.png",
                                      width_in_frames = 8,
                                      height_in_frames = 8
                                  },
                                  {
                                      filename = "__Age-of-Production__/graphics/entity/armory/armory-hr-emission-2.png",
                                      width_in_frames = 8,
                                      height_in_frames = 2
                                  }
                              }
